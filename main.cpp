...
yText=1500;
    ...
    txSleep(50);
    drawDialog(315,215,"Привет,заходи");
    txEnd();
    txSleep(50);
    }
    txSleep(1500);
    ...
    drawDialog(116,170,"Ну,зачем звал?");
    txSleep(1000);
    drawRoom();
    txSetColor(TX_BLACK,5);
    txSetFillColor(TX_BLACK);
    ...
    drawManIsKomnatLeviy();
    drawManIsKomnataPraviy(xHAND,yHAND);
    drawDialog(491,180,"Я нашёл карту...");
    txSleep(1000);
    drawDialog(491,180,"и метка");
    txSleep(1000);
    drawDialog(491,180,"на ней указывает");
    txSleep(1000);
    drawDialog(491,180,"на лес,который");
    txSleep(1000);
    drawDialog(491,180,"находится");
    txSleep(1000);
    drawDialog(491,180,"рядом");
    txSleep(1000);
    drawDialog(491,180,"Понял о чём я?");
    txSleep(1000);
    drawRoom();
    txSetColor(TX_BLACK,5);
    txSetFillColor(TX_BLACK);
    ...
    drawManIsKomnatLeviy();
    drawManIsKomnataPraviy(xHAND,yHAND);
    drawDialog(491,180,"У меня на полке");
    txSleep(1000);
    drawDialog(491,180,"лежит лопата");
    txSleep(1000);
    drawDialog(491,180,"пошли сходим???");
    txSleep(1000);
    drawRoom();
    txSetColor(TX_BLACK,5);
    txSetFillColor(TX_BLACK);
